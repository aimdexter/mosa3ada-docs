```jsx filename="index.jsx" showLineNumbers
"use client";
      ...
      {showBanner && (
        <div className={styles.banner}>
          <Typography variant="body1" className={styles.bannerText}>
            ...
            موقع مساعدة عبارة عن عمل تطوعي غير ربحي من طرف مجموعة من الشباب المغاربة
            لا يمثل أي جهة أو مجموعة، هدفنا هو إيصال الإغاثة الإنسانية لضحايا زلزال
            المغرب.
          </Typography>
          <IconButton
            aria-label="Dismiss"
              ...
              <Link target="_blank" href={"https://t.co/wZ1Xh0CJLV"}>
                <div className={styles.buttonContainer}>
                  <Button
                    ...
                    color="primary"
                  >
                    <EmailOutlinedIcon style={{ marginLeft: "8px" }} /> تواصل
                    معنا
                  </Button>
                </div>
              </Link>
